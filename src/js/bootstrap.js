...
+function ($) {
  ...
  Button.prototype.toggle = function () {
    ...
    if ($parent.length) {
      ...
      if ($input.prop('type') == 'radio') {
        ...
        if (($input.prop('checked')) !== this.$element.hasclassName('active')) changed = false
  ...
  $(document)
    ...
    .on('focus.bs.button.data-api blur.bs.button.data-api', '[data-toggle^="button"]', function (e) {
      $(e.target).closest('.btn').toggleclassName('focus', /^focus(in)?$/.test(e.type))
    })
...
+function ($) {
  ...
  Collapse.prototype.show = function () {
    ...
    this.$element
      ...
      .addclassName('collapsing')[dimension](0)
    ...
    var complete = function () {
      this.$element
        ...
        .addclassName('collapse in')[dimension]('')
  ...
  Collapse.prototype.getParent = function () {
    return $(document).find(this.options.parent)
      ...
      .each($.proxy(function (i, element) {
        var $element = $(element)
        this.addAriaAndCollapsedclassName(getTargetFromTrigger($element), $element)
      }, this))
      .end()
  }

  Collapse.prototype.addAriaAndCollapsedclassName = function ($element, $trigger) {
...
+function ($) {
  ...
  function clearMenus(e) {
    ...
    $(toggle).each(function () {
      ...
      $parent.removeclassName('open').trigger($.Event('hidden.bs.dropdown', relatedTarget))
    })
  }
...
+function ($) {
  ...
  Modal.prototype.measureScrollbar = function () { // thx walsh
    ...
    scrollDiv.classNameName = 'modal-scrollbar-measure'
...
+function ($) {
  ...
  Tab.prototype.activate = function (element, container, callback) {
    ...
    var transition = callback
      && $.support.transition
      && ($active.length && $active.hasclassName('fade') || !!container.find('> .fade').length)
